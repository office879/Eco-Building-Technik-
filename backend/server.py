...
SEED_PRODUCTS = [
    ...
    # ============================================
    # ECO BUILDING TECHNIK — Warmwasser-Wärmepumpen (Hauspumpen Katalog)
    # ============================================
    {"slug": "eco-luft-wasser-wp-wifi",
     "name": "Luft-Wasser-Wärmepumpe mit WiFi",
     "category": "waermepumpen",
     "short_description": "Kompakte Luft-Wasser-Wärmepumpe mit integrierter WiFi-Steuerung. Heizen, Warmwasser und PV-Ready in einem Gerät.",
     "description": "Vielseitige Luft-Wasser-Wärmepumpe für Wohnungen und Einfamilienhäuser. Mit integriertem WiFi-Modul für volle Steuerung per App, Anti-Legionellen-Programm und PV-Überschussladung.\n\nIdeal für moderne Sanierungen oder Neubauten mit Fußbodenheizung. Anschlussfertig vorinstalliert, kompaktes Outdoor-Design. KI-optimierbar über das ECO Building Energiemanagement.",
     "image": "https://static.wixstatic.com/media/cb2c1f_7590cda9a76346dbbd477c2de6fe4be1~mv2.png/v1/fill/w_800,h_800,al_c,q_85,enc_avif,quality_auto/cb2c1f_7590cda9a76346dbbd477c2de6fe4be1~mv2.png",
     "gallery": [
        "https://static.wixstatic.com/media/cb2c1f_7590cda9a76346dbbd477c2de6fe4be1~mv2.png/v1/fill/w_800,h_800,al_c,q_85,enc_avif,quality_auto/cb2c1f_7590cda9a76346dbbd477c2de6fe4be1~mv2.png",
        "https://static.wixstatic.com/media/cb2c1f_c599bc9d26e1432cb68739c65890514df000.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_c599bc9d26e1432cb68739c65890514df000.jpg",
     ],
     "featured": True, "badge": "WIFI · APP",
     "price_from": 2986.0,
     "price_note": "ab 2.986 € Netto · zzgl. 20% MwSt.",
     "specs": {
        "Typ": "Luft-Wasser-Wärmepumpe",
        "Energieklasse": "A+++",
        "Funktion": "Heizen + Warmwasser",
        "Steuerung": "WiFi · App · KNX-ready",
        "Garantie": "3 Jahre",
        "Lieferzeit": "ca. 10–15 Werktage",
     },
     "features": [
        "Integrierte WiFi-Steuerung per App",
        "PV-Überschuss-Ladung",
        "Anti-Legionellen-Programm",
        "Leiser Inverter-Kompressor",
        "Kompakt & wartungsarm",
        "KI-Optimierung möglich (ECO Energy Manager)",
     ]},

    {"slug": "eco-all-in-one-warmwasser-boiler",
     "name": "All-in-One Warmwasser-Boiler",
     "category": "wasser",
     "short_description": "Integrierter Warmwasser-Boiler mit Wärmepumpentechnologie. Verfügbar in 100 / 200 / 300 Liter.",
     "description": "Der All-in-One Warmwasser-Boiler kombiniert Wärmepumpe und Speicher in einem schlanken Gehäuse. Ideal für Wohnungen, Einfamilienhäuser oder Sanierungen mit beschränktem Platz.\n\nVerfügbar in drei Speichergrößen — 100 L (Single-Haushalt), 200 L (Familie) und 300 L (große Haushalte). Energieklasse A+ mit COP bis 3,5. Einfache Wandmontage oder freistehend.",
     "image": "https://static.wixstatic.com/media/cb2c1f_0432ad1619a24f538577babb96708abb~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_0432ad1619a24f538577babb96708abb~mv2.jpg",
     "gallery": [
        "https://static.wixstatic.com/media/cb2c1f_0432ad1619a24f538577babb96708abb~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_0432ad1619a24f538577babb96708abb~mv2.jpg",
        "https://static.wixstatic.com/media/cb2c1f_5ab03ca6132549878165032686a00fdc~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_5ab03ca6132549878165032686a00fdc~mv2.jpg",
     ],
     "featured": False, "badge": "100 / 200 / 300 L",
     "price_from": 1299.0,
     "price_note": "ab 1.299 € Netto · zzgl. 20% MwSt.",
     "specs": {
        "Typ": "All-in-One Warmwasser-Boiler",
        "Speichergrößen": "100 / 200 / 300 L",
        "Energieklasse": "A+",
        "COP": "bis 3,5",
        "Funktion": "Warmwasser",
        "Steuerung": "LCD-Display · WiFi optional",
        "Garantie": "2 Jahre",
        "Lieferzeit": "ca. 10–15 Werktage",
     },
     "features": [
        "Drei Speichergrößen wählbar",
        "Wärmepumpe + Speicher integriert",
        "Anti-Legionellen-Funktion",
        "Wandmontage oder freistehend möglich",
        "Geringer Standby-Verbrauch",
        "Leise im Betrieb (≤ 45 dB(A))",
     ]},

    {"slug": "eco-luft-wasser-wp-warmwasser",
     "name": "Luft-Wasser-Wärmepumpe zur Warmwasserbereitung",
     "category": "wasser",
     "short_description": "Kompakte Warmwasser-Wärmepumpe in drei Größen: HP80M8 (82 L), HP110M8 (102 L), HP150M8 (149 L).",
     "description": "Zuverlässige Luft-Wasser-Wärmepumpe speziell zur Warmwasserbereitung. Drei Varianten mit integriertem Speicher:\n\n• HP80M8-9/B — 82 L · 492×537×1170 mm · 51 kg\n• HP110M8-9/B — 102 L · 492×537×1320 mm · 55 kg\n• HP150M8-9/B — 149 L · 492×537×1320 mm · 67 kg\n\nIdeal für Wohnungen, Mehrfamilienhäuser oder kleine Gewerbeobjekte. Kompakte Stellfläche, einfache Installation, energieeffiziente A+ Klasse.",
     "image": "https://static.wixstatic.com/media/cb2c1f_61076aae60f244c79f974f6832adeec8~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_61076aae60f244c79f974f6832adeec8~mv2.jpg",
     "gallery": [
        "https://static.wixstatic.com/media/cb2c1f_61076aae60f244c79f974f6832adeec8~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_61076aae60f244c79f974f6832adeec8~mv2.jpg",
        "https://static.wixstatic.com/media/cb2c1f_952dae5492b540d5be2adb73819491ed~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_952dae5492b540d5be2adb73819491ed~mv2.jpg",
     ],
     "featured": False, "badge": "NEU",
     "price_from": 890.0,
     "price_note": "ab 890 € Netto · zzgl. 20% MwSt.",
     "specs": {
        "Modelle": "HP80M8 / HP110M8 / HP150M8",
        "Speichergrößen": "82 L / 102 L / 149 L",
        "Maße HP80": "492×537×1170 mm · 51 kg",
        "Maße HP110": "492×537×1320 mm · 55 kg",
        "Maße HP150": "492×537×1320 mm · 67 kg",
        "Energieklasse": "A+",
        "Funktion": "Warmwasserbereitung",
        "Steuerung": "Digital-Display",
        "Garantie": "2 Jahre",
        "Lieferzeit": "ca. 10–15 Werktage",
     },
     "features": [
        "Drei Größen für jede Wohnungs-/Haushaltsklasse",
    ...
    {"slug": "eco-r290-full-inverter-luft-wasser",
     "name": "R290 Full Inverter Luft-Wasser-Wärmepumpe",
     "category": "waermepumpen",
     "short_description": "Premium R290-Vollinverter Luft-Wasser-Wärmepumpe — modernes Kältemittel, höchste Effizienz, A+++.",
     "description": "Full-Inverter-Wärmepumpe mit umweltfreundlichem R290-Propan-Kältemittel (GWP nur 3). Bietet konstante Leistung über den gesamten Lastbereich und arbeitet effizient auch bei niedrigen Außentemperaturen bis −25 °C.\n\nIdeal für Einfamilienhäuser, Sanierungen und Mehrfamilienhäuser. Heizen, Kühlen und Warmwasser in einem Gerät. PV-Ready und KI-Energiemanagement-kompatibel.",
     "image": "https://static.wixstatic.com/media/cb2c1f_0d5bf92043094f8ea9256a8f49c16048~mv2.avif/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_0d5bf92043094f8ea9256a8f49c16048~mv2.avif",
     "gallery": [
        "https://static.wixstatic.com/media/cb2c1f_0d5bf92043094f8ea9256a8f49c16048~mv2.avif/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_0d5bf92043094f8ea9256a8f49c16048~mv2.avif",
        "https://static.wixstatic.com/media/cb2c1f_6f84de53545d4b5daab5c42225a9d359~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_6f84de53545d4b5daab5c42225a9d359~mv2.jpg",
     ],
     "featured": True, "badge": "R290 · A+++",
     "price_from": 4510.0,
     "price_note": "ab 4.510 € Netto · zzgl. 20% MwSt.",
     "specs": {
        "Typ": "Luft-Wasser Full-Inverter",
        "Kältemittel": "R290 (Propan) · GWP 3",
        "Energieklasse": "A+++",
        "COP": "bis 5,2",
        "Betriebstemperatur": "−25 °C bis +43 °C",
        "Funktion": "Heizen + Kühlen + Warmwasser",
        "Vorlauftemperatur": "bis 75 °C",
        "Steuerung": "App · WiFi · KNX/Modbus",
        "Garantie": "5 Jahre",
        "Lieferzeit": "ca. 15 Werktage",
     },
     "features": [
        "Umweltfreundliches R290-Propan-Kältemittel",
        "Full-Inverter — bedarfsgerechte Leistung",
        "Stabiler Betrieb bis −25 °C",
        "PV-Ready & Smart-Grid kompatibel",
        "App-Steuerung + Web-Portal",
        "5 Jahre Garantie",
     ]},

    {"slug": "eco-heizung-kuehlung-haushalts-warmwasser",
     "name": "Heizung · Kühlung · Haushalts-Warmwasser Wärmepumpe",
     "category": "waermepumpen",
     "short_description": "All-in-One Wärmepumpe für Heizung, Kühlung und Warmwasser. Verfügbar in 12 kW und 16 kW.",
     "description": "Vielseitige Wärmepumpe für komplette Haushalts-Wärmeversorgung — heizt im Winter, kühlt im Sommer und liefert das ganze Jahr über Warmwasser. Verfügbar in zwei Leistungsstufen für unterschiedliche Wohnflächen:\n\n• 12 kW — Einfamilienhäuser bis ca. 200 m²\n• 16 kW — Häuser bis ca. 300 m² oder Mehrfamilienhäuser\n\nKI-Optimierung über das ECO Building Energiemanagement möglich. Förderfähig nach österreichischer Klimaförderung.",
     "image": "https://static.wixstatic.com/media/cb2c1f_d8bf0414f39b4c508217f1f773630a15~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_d8bf0414f39b4c508217f1f773630a15~mv2.jpg",
     "gallery": [
        "https://static.wixstatic.com/media/cb2c1f_d8bf0414f39b4c508217f1f773630a15~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_d8bf0414f39b4c508217f1f773630a15~mv2.jpg",
        "https://static.wixstatic.com/media/cb2c1f_ebb0662ad5f649d1b027cc7252e2fb8e~mv2.jpg/v1/fill/w_800,h_800,al_c,q_80,enc_avif,quality_auto/cb2c1f_ebb0662ad5f649d1b027cc7252e2fb8e~mv2.jpg",
     ],
     "featured": True, "badge": "12 / 16 kW",
     "price_from": 3286.0,
     "price_note": "ab 3.286 € Netto · zzgl. 20% MwSt.",
     "specs": {
        "Typ": "Luft-Wasser-Wärmepumpe All-in-One",
        "Leistungsstufen": "12 kW / 16 kW",
        "Energieklasse": "A+++",
        "Funktion": "Heizen + Kühlen + Warmwasser",
        "Anwendung": "bis 300 m² (16 kW-Variante)",
        "Steuerung": "App · WiFi · Modbus",
        "Garantie": "3 Jahre",
        "Lieferzeit": "ca. 15 Werktage",
     },
     "features": [
        "Heizen, Kühlen und Warmwasser in einem Gerät",
        "Zwei Leistungsstufen für jede Hausgröße",
        "KI-Optimierung via ECO Energy Manager",
        "App-Steuerung mit Echtzeit-Monitoring",
        "Förderfähig (österreichische Klimaförderung)",
