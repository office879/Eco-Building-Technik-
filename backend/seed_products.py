"""
ECO Building Technik — Product Seed Data
========================================
Extracted from server.py for better maintainability (~1100 lines of pure data).
Imported by server.py on startup to populate empty MongoDB collections.

Total products: 64
Categories: waermepumpen, gas-brennwert, smart-home, beleuchtung, energiemanagement, wasser
Sources: KRONOTERM (EU), Alibaba (R32/R290), ECO Building Technik catalogue
"""
...
SEED_PRODUCTS = [
    ...
    {"slug": "kronoterm-adapt-max",
     ...
     "featured": False, "badge": "GROSSGEBÄUDE",
    ...
    {"slug": "kronoterm-versi-o",
     ...
     "featured": False, "badge": "PASSIVHAUS",
    ...
    {"slug": "kronoterm-etera-geothermie",
     ...
     "featured": False, "badge": "GEOTHERMIE",
    ...
    {"slug": "jnod-water-heater-200l",
     ...
     "featured": False, "badge": "ALL-IN-ONE",
    ...
    {"slug": "tuya-6inch-smart-panel-scp06",
     ...
     "featured": False, "badge": "NEU · 6\" SCP06",
    ...
    {"slug": "tuya-10inch-smart-panel-knob",
     ...
     "youtube_id": "Nd5y9z4I0ng",
     "featured": False, "badge": "PREMIUM 10\"",
    ...
    {"slug": "smart-panel-ceiling-speakers-set",
     ...
     "featured": False, "badge": "MULTIROOM",
    ...
    {"slug": "jnod-a3-12kw", "name": "JNOD A+++ Wärmepumpe 12kW", "category": "waermepumpen",
     ...
     "image": IMG_HEATPUMP, "featured": False, "badge": "BESTSELLER",
    ...
    {"slug": "jnod-a3-16kw", "name": "JNOD A+++ Wärmepumpe 16kW", "category": "waermepumpen",
     ...
     "image": IMG_HEATPUMP, "featured": False, "badge": "TOP",
    ...
    {"slug": "jnod-heating-warmwasser-11", "name": "JNOD Kombi-Wärmepumpe 11 kWh", "category": "waermepumpen",
     ...
     "image": IMG_HEATPUMP, "featured": False, "badge": "KOMBI",
    ...
    {"slug": "squirrel-m30-25kw", "name": "Squirrel M30 Gas-Boiler 25kW", "category": "gas-brennwert",
     ...
     "image": "https://images.unsplash.com/photo-1574359411659-15573a27fd0c?w=1200&q=80", "featured": False, "badge": "TOP",
    ...
    {"slug": "tongou-switch-1", "name": "TONGOU Smart Switch 1-Gang", "category": "smart-home",
     ...
     "image": IMG_SWITCH, "featured": False, "badge": "BESTSELLER",
    ...
    {"slug": "tongou-dimmer", "name": "TONGOU Smart Dimmer Switch", "category": "smart-home",
     ...
     "image": IMG_SWITCH, "featured": False, "badge": "TOP",
    ...
    {"slug": "tongou-thermostat", "name": "TONGOU Smart Thermostat", "category": "smart-home",
     ...
     "image": IMG_THERMO, "featured": False, "badge": "TOP",
    ...
    {"slug": "girier-zigbee-1", "name": "GIRIER Zigbee Switch Modul 1-Gang", "category": "smart-home",
     ...
     "image": IMG_SWITCH, "featured": False, "badge": "ZIGBEE",
    ...
    {"slug": "girier-gateway", "name": "GIRIER Zigbee Gateway Hub", "category": "smart-home",
     ...
     "image": IMG_SMART, "featured": False, "badge": "HUB",
    ...
    {"slug": "smart-led-e27", "name": "Smart LED-Lampe E27 RGBW", "category": "beleuchtung",
     ...
     "image": "https://images.unsplash.com/photo-1493612276216-ee3925520721?w=1200&q=80", "featured": False, "badge": "TOP",
    ...
    {"slug": "smart-led-strip", "name": "Smart LED-Streifen 5m RGBW", "category": "beleuchtung",
     ...
     "image": "https://images.unsplash.com/photo-1524634126442-357e0eac3c14?w=1200&q=80", "featured": False,
    ...
    {"slug": "smart-energy-monitor", "name": "Smart Energiemonitor Zählerschrank", "category": "energiemanagement",
     ...
     "image": IMG_METER, "featured": False, "badge": "TOP",
    ...
    {"slug": "pv-inverter-5kw", "name": "Smart PV-Wechselrichter 5kW", "category": "energiemanagement",
     ...
     "image": IMG_SOLAR, "featured": False, "badge": "PV",
    ...
    {"slug": "battery-storage-10kwh", "name": "Smart Batteriespeicher 10kWh", "category": "energiemanagement",
     ...
     "image": IMG_BATTERY, "featured": False, "badge": "TOP",
    ...
    {"slug": "smart-water-meter", "name": "Smart Wasserzähler mit WLAN", "category": "wasser",
     ...
     "image": IMG_WATER, "featured": False, "badge": "TOP",
    ...
    {"slug": "eco-all-in-one-warmwasser-boiler",
     ...
     "featured": True, "badge": "100 / 200 / 300 L",
     "price_from": 1299.0,
